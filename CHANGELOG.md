...
- fix: enhance release workflow to handle missing tags gracefully by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/8
- chore: add CLAUDE.md creation step by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/9
- chore: fix release step by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/10

## [v0.0.1](https://github.com/nnnkkk7/gopin/commits/v0.0.1) - 2025-11-29
- feat: set up GoReleaser and tagpr configuration by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/2
- feat: implement gopin by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/1
- fix: update tagpr config and add release.yml by @nnnkkk7 in https://github.com/nnnkkk7/gopin/pull/3
